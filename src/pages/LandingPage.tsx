      ...
      <main className="flex-1">
        <section className="container py-20 md:py-32 flex flex-col items-center text-center space-y-8 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-[600px]">
            Track progress, log reflections, and organize your thoughts between
            sessions. Empowering you to get the most out of every conversation.
          </p>
          ...
          {[
            {
              ...
              desc: 'Your data is encrypted and secure. Your reflections are for your eyes only.',
            },
            {
              icon: Heart,
              title: 'Mood Tracking',
              desc: 'Check in with yourself daily to see patterns in your emotional well-being.',
            },
            {
              icon: Sparkles,
              title: 'Guided Reflection',
              desc: 'Structure your post-session thoughts with guided prompts for deeper insights.',
            },
            {
              icon: TrendingUp,
              title: 'Goal Progress',
              desc: 'Visualize your growth with goal tracking and celebrate your achievements.',
            },
          ].map((item, i) => (
            <div
              key={i}
